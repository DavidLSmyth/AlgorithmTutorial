...
class AlgorithmsControllerTest < ActionController::TestCase
  ...
  test "should create algorithm" do
    assert_difference('Algorithm.count') do
      post :create, algorithm: { author: @algorithm.author, complexityAnalysis: @algorithm.complexityAnalysis, description: @algorithm.description, difficulty: @algorithm.difficulty, link: @algorithm.link, name: @algorithm.name, pseudoCode: @algorithm.pseudoCode }
    end
